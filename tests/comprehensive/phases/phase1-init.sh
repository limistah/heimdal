...
EXPECTED_ERROR="not found\|does not exist\|failed" run_failure heimdal init --repo "invalid/nonexistent-repo-12345" --profile test --path "$INVALID_TEST_DIR/dotfiles"
